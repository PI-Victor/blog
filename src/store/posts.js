const state = {
    posts: [
        ...
        },
        {
            ...
            content: "Donec nibh justo, ultrices pretium ex in, porttitor pharetra arcu. Integer quis malesuada nulla. Proin posuere, ipsum nec consectetur pulvinar, ligula lorem mollis purus, id ornare magna augue eu augue. Nunc non aliquam enim, ut viverra dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse ac eleifend massa. Nunc erat velit, sollicitudin non urna vel, suscipit lacinia felis. ",
        },
        {
            meta: {
                title: "Deploying to kubernetes",
